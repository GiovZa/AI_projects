...
def main(args):
    ...
    predicted_labels = bnb.bigram_bayes(train_set, train_labels, dev_set, args.laplace, args.pos_prior)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--laplace',dest="laplace", type=float, default = 1.3505,
